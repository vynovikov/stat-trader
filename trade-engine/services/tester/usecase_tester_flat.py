...
from services.usecases.usecases_single_engine import UsecasesSingleEngine
...
if __name__ == "__main__":
    ...
    trade_engine_flat = get_flat(
        initial_deposit=initial_ballance,
        metric_repository=metric_repository,
        cfg=cfg,
    )

    usecases = UsecasesSingleEngine(
        trade_engine=trade_engine_flat,
        metric_repository=metric_repository,
    )
